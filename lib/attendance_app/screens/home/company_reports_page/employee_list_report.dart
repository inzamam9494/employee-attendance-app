...
class EmployeeListReport extends StatefulWidget {
  const EmployeeListReport({super.key});

  @override
  State<EmployeeListReport> createState() => _EmployeeListReportState();
}

class _EmployeeListReportState extends State<EmployeeListReport> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        backgroundColor: AppColors.white,
        title: Text("Employee List Report",
