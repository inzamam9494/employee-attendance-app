...
class ProvidentFundChallanReport extends StatefulWidget {
  const ProvidentFundChallanReport({super.key});

  @override
  State<ProvidentFundChallanReport> createState() => _ProvidentFundChallanReportState();
}

class _ProvidentFundChallanReportState extends State<ProvidentFundChallanReport> {
      ...
      body: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Obx(() =>CustomRadioButton(
                options: [
                  RadioOption(value: 1, title: "CSV"),
                  RadioOption(value: 2, title: "TXT"),
                ],
                onChanged: (value, title){
